...
- [ ] [MVP 1.0] **Нижняя навигация (BottomNav):** "Главная" (иконка дома), "Календарь" (иконка календаря), "Программа" (иконка списка), "Прогресс" (иконка графика), "Профиль" (иконка пользователя).
