...
- [x] [MVP 1.0] **Локализация и форматы:**
    - [x] [MVP 1.0] Поддержка языков: Русский, Английский.
    - [x] [MVP 1.0] Настройка формата даты и времени.
- [x] [MVP 1.0] **Дизайн-система и Темы:**
    - [x] [MVP 1.0] Реализация светлой и тёмной тем с возможностью системного выбора.
    - [x] [MVP 1.0] Использование Material Design 3.
    - [ ] [MVP 2.0] Разработка единой дизайн-системы: цветовая палитра, типографика, иконки.
- [ ] [MVP 2.0] **Доступность (Accessibility):**
    - [x] [MVP 1.0] Добавление `contentDescription` для всех интерактивных элементов для поддержки TalkBack.
...
- [x] [MVP 1.0] **Обновление документации:**
    - [x] [MVP 1.0] Поддерживать `README.md` в актуальном состоянии (описание, цели, возможности).
    - [x] [MVP 1.0] Детализировать `PROGRAM_FORMAT.md` с финальной схемой JSON, примерами и описанием полей.
    - [x] [MVP 1.0] Обновлять `ROADMAP.md` и `TODO.md` по мере выполнения задач.
...
- [x] [MVP 1.0] **Первый запуск:** Реализовать онбординг, выбор программы, настройку профиля и даты начала.
...
- [x] [MVP 1.0] **Прерванная тренировка:**
    - [x] [MVP 1.0] Автосохранение прогресса при выходе.
    - [x] [MVP 1.0] UI с опциями: "Продолжить позже", "Завершить досрочно", "Отменить без сохранения".
...
- [x] [MVP 1.0] **Работа в офлайн-режиме:** Обеспечить полную функциональность трекинга без доступа к сет��.
- [x] [MVP 1.0] **Обновления приложения:**
    - [x] [MVP 1.0] Настроить корректную миграцию базы данных при обновлениях схемы.
